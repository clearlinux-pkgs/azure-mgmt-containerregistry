...
License  : MIT
Requires: azure-mgmt-containerregistry-python = %{version}-%{release}
Requires: azure-mgmt-containerregistry-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-containerregistry package.
Group: Default
Requires: azure-mgmt-containerregistry-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-containerregistry package.


%package python3
Summary: python3 components for the azure-mgmt-containerregistry package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_containerregistry)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-containerregistry package.


%prep
%setup -q -n azure-mgmt-containerregistry-2.8.0
cd %{_builddir}/azure-mgmt-containerregistry-2.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588789545
